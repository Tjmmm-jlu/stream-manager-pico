...
public sealed class SemanticObjectSummary
{
    ...
    public static SemanticObjectSummary From(SemanticObject semanticObject)
    {
        return new SemanticObjectSummary
        {
            ...
            function = semanticObject.Function,
            color = semanticObject.Color,
            transparency = semanticObject.Transparency,
            shape = semanticObject.Shape,
            materials = semanticObject.Materials.ToArray(),
            contents = semanticObject.Contents,
            contentColor = semanticObject.ContentColor,
            stateTags = semanticObject.StateTags.ToArray(),
